...
def get_parser():
    ...
    parser.add_argument("--lambda_char", type=float, default=0, help='char class loss lambda')
    parser.add_argument("--lambda_GAN", type=float, default=5.0, help='GAN loss lambda')
    parser.add_argument("--lambda_cx", type=float, default=0, help='Contextual loss lambda')
